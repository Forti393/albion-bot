...
def get_main_kb(d):
    ...
    if searched:
        ...
        # Кнопка допомоги зникає, якщо умови виконані
...
async def cmd_help(m, state: FSMContext):
    help_text = (
        ...
        "• <b>📊 Попит:</b> Аналізує об'єм продажів за добу.\n"
...
# Решта хендлерів (30хв, Попит тощо)
